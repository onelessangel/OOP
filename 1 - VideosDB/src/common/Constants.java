...
/**
 * The class contains the constants needed by the implementation and by the checker.
 */
public final class Constants {
    ...
    public static final String BEST_RATED_UNSEEN = "bestRatedUnseen";
    public static final String POPULAR = "popular";
    public static final String SEARCH = "search";

    // used for GenrePopularity
    public static final String TV_MOVIE_BASIC = "Tv_movie";
    public static final String TV_MOVIE = "TV Movie";
    public static final String SCI_FI_FANTASY_BASIC = "Sci_fi_fantasy";
    public static final String SCI_FI_FANTASY = "Sci-Fi & Fantasy";
    public static final String SCIENCE_FICTION_BASIC = "Science_fiction";
    public static final String SCIENCE_FICTION = "Science Fiction";
    public static final String ACTION_ADVENTURE_BASIC = "Action_adventure";
    public static final String ACTION_ADVENTURE = "Action & Adventure";
}
